...
liquid$initFields(fahr1 = protoField(fahrenheit1),
...
```{r}
watter <- liquid$new("watter",
                  expr = expression(freezing_temp = 0, boiling_temp = 100))
